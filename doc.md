...
see section <a href="#sec:naming" data-reference-type="ref"
data-reference="sec:naming">3.2</a>.
...
will not be discussed at this point. Please have a look at and .
...
3.  Select the options as shown in fig.
    ...
    data-reference="fig:bioformats-1">4.1</a>. Especially ’Split
...
7.  Check all boxes as shown in fig.
    ...
    data-reference="fig:bioformats-2">4.2</a>. This will hide the import
...
4.  Enter the fields as shown in fig.
    ...
    data-reference="fig:unet-plugin">4.3</a>. The model-file (filename
...
6.  When executing the plugin for the first time a few dialogs need to
    ...
    data-reference="fig:ssh-messages">4.4</a>.
...
3.  This opens a new window showing the source code of the script (see
    fig. <a href="#fig:image-script" data-reference-type="ref"
    data-reference="fig:image-script">4.5</a>)
...
4.  Change the server settings and adapt the file paths of the RSA- and
    ...
    data-reference="fig:image-script">4.5</a> - line number might change
...
<a href="#fig:script-settings-window" data-reference-type="ref"
data-reference="fig:script-settings-window">4.7</a>). Below the details
...
- processing: Used by Mathematica (see chapter
  <a href="#cha:mathematica-part1" data-reference-type="ref"
  data-reference="cha:mathematica-part1">5</a> and
  <a href="#cha:mathematica-part2" data-reference-type="ref"
  data-reference="cha:mathematica-part2">6</a>) to save the processed
  image
...
- segmented_overlay: Stores an overlay image, that can be used validate
  ...
  data-reference="fig:unet-output">4.8</a>
...
in fig. <a href="#fig:imagej-error-1" data-reference-type="ref"
data-reference="fig:imagej-error-1">4.9</a>). Restarting ImageJ and/or
...
<a href="#ssec:folder-naming" data-reference-type="ref"
data-reference="ssec:folder-naming">3.2.1</a>) and if all microscopic
...
<a href="#fig:imagej-error-3" data-reference-type="ref"
data-reference="fig:imagej-error-3">4.11</a>). After this initial
...
(<a href="#fig:imagej-error-4" data-reference-type="ref"
data-reference="fig:imagej-error-4">4.12</a>). The file paths need to be
checked (see section
<a href="#ssec:adapt-script" data-reference-type="ref"
data-reference="ssec:adapt-script">4.4.4</a>) and corrected.
...
<a href="#fig:imagej-error-7" data-reference-type="ref"
data-reference="fig:imagej-error-7">4.13</a>). Click on ’Abbrechen’ or
’cancel’ and check the file paths (see section
<a href="#ssec:adapt-script" data-reference-type="ref"
data-reference="ssec:adapt-script">4.4.4</a>).
...
<a href="#fig:imagej-error-5" data-reference-type="ref"
data-reference="fig:imagej-error-5">4.14</a>). Make sure the file paths
...
when any step in the script might cause problems (shown in
<a href="#fig:imagej-error-6" data-reference-type="ref"
data-reference="fig:imagej-error-6">4.15</a>). In this case restart
...
described below (<a href="#sec:math-step1-run" data-reference-type="ref"
data-reference="sec:math-step1-run">5.4</a>). For technical insights
...
data-reference="fig:mathematica-script-screen">5.1</a>). The header
...
section <a href="#ssec:folder-naming" data-reference-type="ref"
data-reference="ssec:folder-naming">3.2.1</a>). After finishing the
U-Net processing the Mathematica script needs to be placed in the parent
folder, as shown in the folder tree at
<a href="#ssec:folder-naming" data-reference-type="ref"
data-reference="ssec:folder-naming">3.2.1</a>. No files or folders need
...
notebook (see fig.
<a href="#fig:mathematica-script-screen" data-reference-type="ref"
data-reference="fig:mathematica-script-screen">5.1</a>).
...
6.  Adapt the settings in the second block if required (see
    <a href="#sec:math-step1-settings" data-reference-type="ref"
    data-reference="sec:math-step1-settings">5.5</a> for details).
...
data-reference="fig:zo1-excel-1">5.2</a> for an example of the file
...
data-reference="fig:zo1-excel-2">5.3</a> for an example of the file
...
<a href="#fig:mathematica-error" data-reference-type="ref"
data-reference="fig:mathematica-error">5.4</a>). In most cases it helps
...
<a href="#cha:mathematica-part1" data-reference-type="ref"
data-reference="cha:mathematica-part1">5</a>, the second step in
...
The script is build very similar compared to the detection scripts (see
section <a href="#sec:math-step1-scripts" data-reference-type="ref"
data-reference="sec:math-step1-scripts">5.2</a> and image
<a href="#fig:mathematica-script-screen" data-reference-type="ref"
data-reference="fig:mathematica-script-screen">5.1</a>).
...
<a href="#sec:mathematica-data-prep" data-reference-type="ref"
data-reference="sec:mathematica-data-prep">6.2</a>. The script will
automatically detect all ’data_input’ folders.

## Run the scripts

The execution of the Mathematica notebook is similar to the previous
part (<a href="#sec:math-step1-run" data-reference-type="ref"
data-reference="sec:math-step1-run">5.4</a>). Depending on the number of
...
| fileMeanCutoff | 0 | When using the fileMean analysis (see section <a href="#ssec:mathematica-part2-output-zo1" data-reference-type="ref"
data-reference="ssec:mathematica-part2-output-zo1">6.6.1</a>) the scripts lets the user define a cut off value. Background: It could be problematic if an image with only 1 detected cell is weighted the same as a file with 20 detected cells. Images with less detected cells than the defined value are excluded. |
...
<a href="#ssaec:math-step1-zo1-excel1" data-reference-type="ref"
data-reference="ssaec:math-step1-zo1-excel1">5.6.1.1</a> and
<a href="#ssaec:math-step1-zo1-excel2" data-reference-type="ref"
data-reference="ssaec:math-step1-zo1-excel2">5.6.1.2</a>.
...
fig.<a href="#fig:zo1-export-pdf" data-reference-type="ref"
data-reference="fig:zo1-export-pdf">6.1</a>) a smooth histogram (y-axis
...
<a href="#sec:math-step1-errors" data-reference-type="ref"
data-reference="sec:math-step1-errors">5.7</a> the execution of the
